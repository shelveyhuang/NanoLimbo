...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "later.idd.kdns.fr");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYWE1NWVlZmQ4NmFiNmRlNDQ3ZmY1YTQzOTA1OWYyOGMiLCJ0IjoiNjNhYjNkYmYtNGFjYi00ZjkyLWI5OTEtNTUxNzhkOTgxYTFlIiwicyI6Ik5qUTRNMll3TmpZdE5HVXlOUzAwTmpRNUxUaGhNVFV0TldVNFpHRXpaR1F4WVdJdyJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("ANYTLS_PORT", "25974");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空

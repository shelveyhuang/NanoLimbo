...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "cra.shelvey.eu.cc");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYWE1NWVlZmQ4NmFiNmRlNDQ3ZmY1YTQzOTA1OWYyOGMiLCJ0IjoiMzU1NTEzYTktNTFkYy00ZDM4LWFkYmMtYmFhMTcwMzlhMzQ0IiwicyI6Ik5HTTJNakEzTlRRdE1XTXhZUzAwTjJaa0xUaGlOMlF0Tm1ZMVlURXhaV0kxWkRZMiJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "16833");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "16833");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空

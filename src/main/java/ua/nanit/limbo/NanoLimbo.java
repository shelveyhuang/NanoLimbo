...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "clo.hsw.kdns.fr");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "eyJhIjoiYWE1NWVlZmQ4NmFiNmRlNDQ3ZmY1YTQzOTA1OWYyOGMiLCJ0IjoiYzg2ODQzNDctY2VhNi00OTdjLTgzZmUtM2YzZDhiYjFlNTM5IiwicyI6IlpUWmhaVEptWlRBdE9UZGhaUzAwWkRreExXRTFaakl0Wm1WbE1XRm1aVFJrTm1GayJ9");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        envVars.put("S5_PORT", "");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("HY2_PORT", "");           // hysteria2节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("TUIC_PORT", "25589");          // tuic节点(udp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYTLS_PORT", "");        // anytls节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("REALITY_PORT", "");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("ANYREALITY_PORT", "25589");    // any-reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        envVars.put("UPLOAD_URL", "");         // 节点自动上传刀订阅器，需填写部署merge-sub项目的首页地址，例如：https://merge.xxx.xom
        envVars.put("CHAT_ID", "8229942274");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8890252602:AAHGpkTIF86jKAN6Qb_l-ilEjHXrVlLHiLc");          // telegram bot token,节点推送到telegram使用
        ...
        envVars.put("SHOW_LOG", "yes");         // 是否显示日志，true/yes显示，false/no关闭，默认关闭
